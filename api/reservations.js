  ...
  if (req.method === "POST") {
    ...
    try {
        ...
        await sendEmail(
          ...
          `
            ...
            <p>
              ...
              skontrolujte aj priečinok
              Spam alebo Nevyžiadaná pošta.
            </p>
      ...
      if (type === "club") {
        ...
        if (
          !allowedStartTimes.includes(
            start_time
          ) ||
          !allowedEndTimes.includes(
            end_time
          )
        ) {
