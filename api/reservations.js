...
export default async function handler(req, res) {
  ...
  // ==========================================
  // GET – zobrazovanie voľných miest
  // ==========================================
  ...
  if (req.method === "GET") {
    ...
    try {
      ...
      // ------------------------------
      // KLUB – počet ľudí na každú hodinu
      // ------------------------------
      ...
      return res.status(200).json({
        ...
        course: {
          ...
          available:
            Math.max(0, 10 - courseReservations)
        }
    ...
    try {
      ...
      if (type === "course") {
        ...
        if (courseCount >= 10) {
          ...
          return res.status(400).json({
            error: "Keramický kurz je už plne obsadený."
          });
      ...
      if (type === "club") {
        ...
        if (
          ...
          return res.status(400).json({
            error: "Vyplňte všetky údaje a vyberte čas."
          });
        ...
        // ======================================
        // KONTROLA 10 ĽUDÍ NA KAŽDÚ HODINU
        // ======================================

        const startHour =
          parseInt(start_time.substring(0, 2));

        const endHour =
          parseInt(end_time.substring(0, 2));
